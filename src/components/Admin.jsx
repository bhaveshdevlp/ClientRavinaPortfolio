      ...
      try {
        ...
        if (data.secure_url) {
          ...
          try {
            ...
            console.log('No JSON in save response');
          }
          if (saveResponse.ok) {
            setUploadedImages(prev => [...prev, saveData]);
          } else {
            alert(saveData?.message || 'Error saving image to backend');
          }
        } else {
          alert(data?.error?.message || 'Error uploading to Cloudinary');
        }
    ...
    const fetchImages = async () => {
      try {
        ...
        try {
          ...
          console.log('No JSON in fetch images response');
        }
        if (response.ok) {
