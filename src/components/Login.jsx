...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('https://ravinaclientasfdfdhgtv.vercel.app/api/auth/login', {
        method: 'POST',
        headers: {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-r from-pink-50 to-purple-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8 bg-white p-10 rounded-xl shadow-lg">
        <div>
          ...
          <p className="mt-2 text-center text-sm text-gray-600">
            Access your makeup portfolio admin panel
          </p>
        </div>
